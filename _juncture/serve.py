...
not_found_page = open(f'{BASEDIR}/404.html', 'r').read() if os.path.exists(f'{BASEDIR}/_includes/header.html') else '<!doctype html><html lang="en"><title>404</title><div>Not Found</div></html>'
